...
secp*) 
    ...
    openssl ecparam -out server_key.key  -name $OQSSIGALG -genkey && \
    openssl ecparam -out client_key.key -name $OQSSIGALG -genkey&& \
    openssl ecparam -out ca_key.key -name $OQSSIGALG -genkey
;;
*) 
